...
def on_start():
    ...
    try:
        ...
        #close reply.txt for reading
        file.close()

        #get replies from reply.txt created
        reply_file = open("Anone-reply.txt", encoding="utf-8")
...
#reply with data extracted from reply.txt
def main_reply(name=""):
    g = False
    #get reply
